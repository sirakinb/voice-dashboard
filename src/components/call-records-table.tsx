      ...
      <div className="overflow-x-auto">
        <table className="min-w-full divide-y divide-jackson-cream-dark text-left text-sm text-jackson-text-muted">
          ...
          <tbody className="divide-y divide-jackson-cream-dark bg-jackson-white">
            {records.map((record) => (
              <tr key={record.callNumber} className="align-top hover:bg-jackson-cream/50 transition-colors">
                <td className="px-6 py-4 font-medium text-jackson-charcoal">
                  {record.createdTime}
                </td>
                <td className="px-6 py-4">
                  <div className="flex items-center gap-3">
                    <div className="flex h-8 w-8 items-center justify-center rounded-full bg-jackson-charcoal text-sm font-semibold text-white">
                ...
                <td className="px-6 py-4">
                  <a
                    ...
                    className="text-sm font-medium text-jackson-green hover:text-jackson-green-light"
                  >
                    ▶ Play
                  </a>
                </td>
